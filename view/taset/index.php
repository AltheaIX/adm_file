          ...
          <h1 class="h3 mb-2 text-gray-800">Transaksi</h1>
           <form class="form-horizontal" method="post" action="insert.php">
              ...
              <div class="form-group">
                <label class="control-label col-sm-3">Aset Tetap :</label>
                <div class="col-sm-9">
                  <?php                    
                    $sql_aset_tetap = mysqli_query($con,"SELECT * FROM aset_tetap ORDER BY nama ASC");
					
                   ?>
                  <select class="form-control" name="aset_tetap" id="aset_tetap">
                    <option></option>
                    <?php                       
                        while($aset_tetap = mysqli_fetch_assoc($sql_aset_tetap)){ 
                           echo '<option value="'.$aset_tetap['id'].'">'.$aset_tetap['nama'].'</option>';
                        }                        
                      ?>
                  </select>
              ...
              <div class="form-group">
                <label class="control-label col-sm-3" >Aset Item :</label>
                <div class="col-sm-9">          
                  <select class="form-control" name="aset_item" id="aset_item">
                    <option></option>
                  </select>
