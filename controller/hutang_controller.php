<?php
	...
	if($op == "tambah"){
        ...
        if($stmt){		
			echo "<script>alert('Berhasil Tambah'); document.location.href=('../view/m_hutang')</script>";
		}else{
			echo "<script>alert('Gagal Tambah'); document.location.href=('../view/m_hutang')</script>";
		}
		...
		if($stmt){		
			echo "<script>alert('Berhasil Menghapus'); document.location.href=('../view/m_hutang/')</script>";
		}else{
			echo "<script>alert('Gagal Menghapus'); document.location.href=('../view/m_hutang/')</script>";
		}
