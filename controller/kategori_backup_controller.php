<?php
	...
	if($op == "tambah"){
        ...
        if($stmt){		
			echo "<script>alert('Berhasil Tambah'); document.location.href=('../view/kategori')</script>";
		}else{
			echo "<script>alert('Gagal Tambah'); document.location.href=('../view/kategori')</script>";
		}
  ...
  if($op == "daftar"){
        ...
        try {
          $sql = "UPDATE kategoris SET 
            user_id = :user_id, 
            name = :name, 
            desk = :desk WHERE id = $id" 
        ...
        if($stmt){		
			echo "<script>alert('Data telah dirubah'); document.location.href=('../view/kategori')</script>";
		}else{
			echo "<script>alert('Gagal Data telah dirubah'); document.location.href=('../view/kategori')</script>";
		}
		...
		if($stmt){		
			echo "<script>alert('Berhasil Menghapus'); document.location.href=('../view/kategori/')</script>";
		}else{
			echo "<script>alert('Gagal Menghapus'); document.location.href=('../view/kategori/')</script>";
		}
